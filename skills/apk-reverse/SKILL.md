...
- `jadx` `1.5.6`
- `apktool` `3.0.3`
- `frida-tools` `14.10.4` (`frida` core `17.18.0`; provides `frida-ps`)
...
Common commands (Apktool 3 supports AAPT2 only and requires a 64-bit runtime; the legacy `-api` option is removed):
