...
| [go-rust-reverse](go-rust-reverse/SKILL.md) | Use to reverse engineer Go and Rust binaries with symbols removed. Identify runtime features, recover pclntab and module data with redress and GoReSym, analy... |
